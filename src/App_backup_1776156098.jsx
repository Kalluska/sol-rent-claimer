    ...
    <>
      <div
        style={{
          ...
          inset: 0,
          background: claim
            ? "radial-gradient(circle at 12% 8%, rgba(22,17,66,0.55), transparent 30%), radial-gradient(circle at 88% 15%, rgba(90,31,170,0.18), transparent 30%), #070111"
            : "radial-gradient(circle at 12% 8%, rgba(22,17,66,0.58), transparent 31%), radial-gradient(circle at 88% 15%, rgba(90,31,170,0.16), transparent 30%), #070111",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        style={{
          position: "absolute",
          right: claim ? "-140px" : "-105px",
          top: claim ? "90px" : "96px",
          width: claim ? "700px" : "720px",
          height: claim ? "700px" : "720px",
          borderRadius: "50%",
          background:
            "radial-gradient(circle at 38% 38%, rgba(210,165,255,0.60), rgba(139,92,246,0.28) 40%, rgba(71,25,123,0.12) 61%, transparent 76%)",
      ...
      <div
        style={{
          position: "absolute",
          right: claim ? "110px" : "120px",
          top: claim ? "236px" : "226px",
          width: claim ? "530px" : "620px",
          height: claim ? "390px" : "430px",
          borderRadius: "50%",
      ...
      <div
        style={{
          position: "absolute",
          right: claim ? "154px" : "160px",
          top: claim ? "248px" : "232px",
          width: "10px",
          height: "10px",
          borderRadius: "50%",
          background: "#8B5CF6",
          boxShadow: "0 0 90px rgba(168,85,247,0.65), 0 25px 80px rgba(236,72,153,0.35)",
          pointerEvents: "none",
        }}
      />
      ...
      <div
        style={{
          position: "absolute",
          right: claim ? "106px" : "110px",
          top: claim ? "566px" : "562px",
          width: "11px",
          height: "11px",
          borderRadius: "50%",
          background: "#8B5CF6",
  ...
  return (
    <button
      ...
      style={{
        ...
        border: 0,
        borderRadius: "28px",
        background: "radial-gradient(circle at 30% 40%, rgba(168,85,247,0.08), transparent 60%), radial-gradient(circle at 80% 20%, rgba(236,72,153,0.08), transparent 60%), linear-gradient(180deg, rgba(7,8,16,0.98), rgba(6,7,14,0.98))",
        color: "#FFFFFF",
        fontWeight: 900,
        letterSpacing: "-0.03em",
        boxShadow: "0 0 90px rgba(168,85,247,0.65), 0 25px 80px rgba(236,72,153,0.35), 0 0 34px rgba(168,85,247,0.34), 0 12px 40px rgba(236,72,153,0.16)",
        cursor: "pointer",
      }}
    >
      {children}
...
function HeroLeft({ goClaim }) {
  return (
    ...
    >
      ...
      >
        Scan your wallet and instantly reclaim locked SOL from unused accounts.
      </p>
      ...
      >
        <FeatureItem icon={<ShieldIcon />} label="Non-custodial" width="128px" />
        <FeatureItem icon={<LockIcon />} label="Secure" width="120px" />
        <FeatureItem icon={<BoltIcon />} label="Fast & Open Source" width="176px" />
      </div>

      <div style={{ marginTop: "36px", maxWidth: "390px" }}>
      </div>
    </section>
  );
}
  ...
  return (
    <div
      style={{
        ...
        background: "radial-gradient(circle at 30% 40%, rgba(168,85,247,0.08), transparent 60%), radial-gradient(circle at 80% 20%, rgba(236,72,153,0.08), transparent 60%), linear-gradient(180deg, rgba(7,8,16,0.98), rgba(6,7,14,0.98))",
            boxShadow: "0 0 90px rgba(168,85,247,0.65), 0 25px 80px rgba(236,72,153,0.35), 0 0 86px rgba(124,58,237,0.12), inset 0 0 0 1px rgba(255,255,255,0.06)",
        padding: "42px 44px 34px 44px",
        position: "relative", maxHeight:"100vh", overflow:"hidden",
        overflow: "hidden",
      }}
    >
      <div
