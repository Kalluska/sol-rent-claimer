    ...
    <>
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background: "#8B5CF6",
          boxShadow: "0 0 60px rgba(168,85,247,0.45), 0 20px 60px rgba(236,72,153,0.25)",
          pointerEvents: "none",
        }}
      />
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: "0 0 60px rgba(168,85,247,0.45), 0 20px 60px rgba(236,72,153,0.25), 0 0 34px rgba(168,85,247,0.34), 0 12px 40px rgba(236,72,153,0.16)",
        cursor: "pointer",
      }}
    >
      {children}
    ...
    <div
      style={{
        ...
        background: "linear-gradient(180deg, rgba(7,8,16,0.98), rgba(6,7,14,0.98))",
            boxShadow: "0 0 60px rgba(168,85,247,0.45), 0 20px 60px rgba(236,72,153,0.25), 0 0 86px rgba(124,58,237,0.12), inset 0 0 0 1px rgba(255,255,255,0.03)",
